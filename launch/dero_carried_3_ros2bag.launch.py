...
def generate_launch_description():
    est_save_dir_arg = DeclareLaunchArgument('est_save_dir',default_value = '/home/vietdo/Desktop/viet_est/carried_3/scekf_dero_carried_3_est.txt',description = '')
    ...
    coarse_alignment_window_size_arg  = DeclareLaunchArgument('coarse_alignment_window_size',default_value = '11900',description = 'IMU step')
