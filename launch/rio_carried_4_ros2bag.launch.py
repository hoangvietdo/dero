...
def generate_launch_description():
    est_save_dir_arg = DeclareLaunchArgument('est_save_dir',default_value = '/home/vietdo/Desktop/viet_est/carried_4/ekf_rio_carried_4_est.txt',description = '')
    bag_dir_arg      = DeclareLaunchArgument('bag_dir',     default_value = '/home/vietdo/Downloads/radar_inertial_datasets_icins_2021/carried_datasets/carried_4/carried_4.db3',description = '');
    ...
    radar_scale_random_walk_arg       = DeclareLaunchArgument('radar_scale_random_walk',default_value = '0.001',    description = 'standard deviation')

    # Simulation scenario
    use_radar_arg                     = DeclareLaunchArgument('use_radar',                   default_value = 'true', description = '')
    use_dr_structure_arg              = DeclareLaunchArgument('use_dr_structure',            default_value = 'false',description = '')
    use_cloining_arg                  = DeclareLaunchArgument('use_cloning',                 default_value = 'false',description = '')
    ...
    coarse_alignment_window_size_arg  = DeclareLaunchArgument('coarse_alignment_window_size',default_value = '12000',description = '')
    ...
    transform_eps_arg                 = DeclareLaunchArgument('transform_eps',              default_value = '0.0000001',description = '')
    euclidean_fit_eps_arg             = DeclareLaunchArgument('euclidean_fit_eps',          default_value = '0.0000001',description = '')
    ...
    ransac_outlier_reject_thres_arg   = DeclareLaunchArgument('ransac_outlier_reject_thres',default_value = '0.0',      description = '')  
