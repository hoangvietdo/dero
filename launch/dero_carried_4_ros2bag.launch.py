...
def generate_launch_description():
    ...
    est_save_dir_arg = DeclareLaunchArgument('est_save_dir',
                                              default_value = '/home/vietdo/Desktop/viet_est/carried_4/scekf_dero_carried_4_est.txt',
                                              description = '')
    bag_dir_arg = DeclareLaunchArgument('bag_dir',
                                         default_value = '/home/vietdo/Downloads/radar_inertial_datasets_icins_2021/carried_datasets/carried_4_fixed/carried_4_fixed_0.db3',
                                         description = '');
