...
def generate_launch_description():
    est_save_dir_arg = DeclareLaunchArgument('est_save_dir',default_value = '/home/vietdo/Desktop/viet_est/carried_5/ekf_rio_carried_5_est.txt',description = '')
    bag_dir_arg      = DeclareLaunchArgument('bag_dir',     default_value = '/home/vietdo/Downloads/radar_inertial_datasets_icins_2021/carried_datasets/carried_5/carried_5.db3',description = '');
