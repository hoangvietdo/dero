...
def generate_launch_description():
    ...
    est_save_dir_arg                  = DeclareLaunchArgument('est_save_dir',                  default_value = '/home/vietdo/Desktop/viet_est/carried_1/ekf_rio_carried_1_est.txt',  description = '')
    ...
    coarse_alignment_window_size_arg  = DeclareLaunchArgument('coarse_alignment_window_size',  default_value = '5000',     description = '')
    ...
    default_value = '/home/vietdo/Downloads/radar_inertial_datasets_icins_2021/carried_datasets/carried_1/carried_1.db3', description = '');
